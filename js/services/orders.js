// ============================================
// СЕРВИС ЗАКАЗОВ (ИСПРАВЛЕНО - arrayUnion, даты, статусы)
// ============================================
...
const Orders = (function() {
    ...
    async function respondToOrder(orderId, price, comment) {
        try {
            ...
            const result = await db.runTransaction(async (transaction) => {
                ...
                // ИСПРАВЛЕНО: используем FieldValue.serverTimestamp() внутри транзакции
                const response = {
                    masterId: user.uid,
                    ...
                    createdAt: firebase.firestore.FieldValue.serverTimestamp() // ✅ Правильно!
                };
    ...
    console.log('✅ Orders сервис загружен (с исправленным arrayUnion)');
